...
module.exports = function(app) {
  ...
  plugin.start = function(props) {
    ...
    try {
      ...
      }, ['navigation.position', 'navigation.speedOverGround', 'navigation.courseOverGroundTrue', 'navigation.headingTrue'].map(app.streambundle.getSelfStream, app.streambundle)).changes().debounceImmediate(60000).onValue(msg => {
